<?php
   ...
   switch($key)
   {
      ...
      case "create":
         ...
         try {
            $sql 	= "INSERT INTO menu(nama_menu, harga) VALUES(:name, :harga)";
      ...
      case "update":
         ...
         // Attempt to run PDO prepared statement
         try {
            $sql 	= "UPDATE menu SET nama_menu = :name, harga = :harga WHERE id_menu = :recordID";
            $stmt 	=	$pdo->prepare($sql);
            $stmt->bindParam(':name', $name, PDO::PARAM_STR);
            $stmt->bindParam(':harga', $harga, PDO::PARAM_STR);
      ...
      case "delete":
         ...
         try {
            ...
            $sql 	= "DELETE FROM menu WHERE id_menu = :recordID";
            $stmt 	= $pdo->prepare($sql);
            $stmt->bindParam(':recordID', $recordID, PDO::PARAM_INT);
            $stmt->execute();
